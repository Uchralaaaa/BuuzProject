...
YOLO (You Only Look Once) бол объект таних нейрон сүлжээний загвар бөгөөд реал таймд дүрс болон видеон дээр объектуудыг хурдан танихад зориулагдсан. Yolo нь ийм олон төрөл байдаг бөгөөд ер нь бол миний 60хан зурганд бол Yolo11n буюу nano л хангалттай. Гэхдээ арай илүү accurate байлгахын тулд Yolo11s буюу small-ийг нь хэрэглэсэн билээ.
...
Энд юу болж байна вэ гэхээр би "ACCIDENTALLY" за аксидэнталли бас бишээ, мэдэхгүй болохоор эхлээд CPU-ээрээ сургаад бараг 2 цаг болсон юм л даа. 7 секунд гэж байгаа биз.  
...
Энд харин ашгүй ойлгоод GPU-ээрээ сургаад, ихдээ л 5 минутын ажил болсон байх хэхэ.
